...
public class SwingUI extends javax.swing.JFrame {
   ...
   private javax.swing.JButton vymazKontaktButton;
    ...
    private void buttonsModifikator(){
        ...
        pridajKontaktButton.setName("pordajKontaktButton");
    ...
    public void obsluhaPouzivatelMenu(){
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(pridajKontaktButton)
                .addGap(18, 18, 18)
                .addComponent(vymazKontaktButton)
                .addGap(18, 18, 18)
                .addComponent(hladajKontaktButton)
                .addContainerGap(124, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public void adminPouzivatelMenu(){
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(odhlasenieButton)
                .addGap(18, 18, 18)
                .addComponent(pridajObsluhaButton)
                .addGap(18, 18, 18)
                .addComponent(vymazObsluhaButton)
                .addContainerGap(236, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
